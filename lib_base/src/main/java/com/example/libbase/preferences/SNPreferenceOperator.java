 ...
 *
 * @author xiewenyong
 * @date 2019-2-11 16:38:53
 */
public class SNPreferenceOperator {
    private SharedPreferences mPreferences;

    public SNPreferenceOperator(SharedPreferences preferences) {
    ...
    public void put(String key, Serializable value) {
        try {
            ...
            String valueBase64 = new String(Base64.encode(outputStream.toByteArray(), Base64.DEFAULT));
            SharedPreferences.Editor editor = mPreferences.edit();
    ...
    public <T extends Serializable> T getSerializable(String key) {
        ...
        if (objBase64 != null && !"".equals(objBase64)) {
            try {
