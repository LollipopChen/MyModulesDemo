 ...
 * SuperNovaFramework
 * ToastAlert
 * Created by Leo.Mok on 2018-03-28.
 * Copyright © 2018 Supernova Software. All rights reserved.
 */

package com.example.libbase.widget.toast;
 ...
 *     ToastAlert.show(getStr("this is a text only toast");
 *
 *     // show a simple toast immediately that with a text and a icon
 *     ToastAlert.show(getStr("this is toast with a icon", R.drawable.icon);
 *
 ...
 * </pre>
 * <p>
 * more and more powerful usage - use custom drawable(please see wiki)
 */
